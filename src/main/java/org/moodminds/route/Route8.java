...
/**
 * Route definition function by the {@link Flow} and 8 argument values which returns the routing result.
 *
 ...
 */
@FunctionalInterface
public interface Route8<$F extends Flow<?, ?>, I1, I2, I3, I4, I5, I6, I7, I8, $R extends Routing<?>> {
