...
/**
 * Route definition function by the {@link Flow} and 4 argument values which returns the routing result.
 *
 ...
 */
@FunctionalInterface
public interface Route4<$F extends Flow<?, ?>, I1, I2, I3, I4, $R extends Routing<?>> {
     ...
     */
    $R route($F flow, Value<I1> value1, Value<I2> value2, Value<I3> value3, Value<I4> value4);
}
