...
/**
 * Route definition block by 4 argument values.
 *
 ...
 */
@FunctionalInterface
public interface Block4<I1, I2, I3, I4, $R extends Routing<?>> {
     ...
     */
    $R block(Value<I1> value1, Value<I2> value2, Value<I3> value3, Value<I4> value4);
}
