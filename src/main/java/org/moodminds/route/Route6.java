...
/**
 * Route definition function by the {@link Flow} and 6 argument values which returns the routing result.
 *
 ...
 */
@FunctionalInterface
public interface Route6<$F extends Flow<?, ?>, I1, I2, I3, I4, I5, I6, $R extends Routing<?>> {
     ...
     */
    $R route($F flow, Value<I1> value1, Value<I2> value2, Value<I3> value3, Value<I4> value4, Value<I5> value5, Value<I6> value6);
}
